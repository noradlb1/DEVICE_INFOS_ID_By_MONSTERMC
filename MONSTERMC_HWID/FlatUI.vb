...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        With G
            ...
            '-- Logo
            .DrawIcon(FindForm.Icon, New Rectangle(8, 16, 18, 18))
...
#Region " Colors"
    ...
    Private BaseColorBlue As Color = Color.FromArgb(0, 151, 230)
        ...
        With G
            ...
            Select Case O
                ...
                Case _Options.Style4
                    ...
                    GP2.AddEllipse(Toggle)
                    .FillPath(New SolidBrush(ToggleColor), GP)
                    .FillPath(New SolidBrush(BaseColorBlue), GP2)

                    '-- Text
                    .DrawString("1", Font, New SolidBrush(BaseColorBlue), New Rectangle(-12, 2, W, H), CenterSF)
                    ...
                    If Checked Then
                        ...
                        '-- Text
                        .DrawString("2", Font, New SolidBrush(BaseColor), New Rectangle(12, 2, W, H), CenterSF)
                    End If
            End Select
